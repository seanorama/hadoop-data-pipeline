...
su - ${demo_user} -c "hdfs dfs -put /usr/hdp/current/atlas-server/hook/hive/*.jar /user/${demo_user}/data_pipeline_demo/jars/"
...
mkdir -p /tmp/data_pipeline_demo/input ; chmod 777 /tmp/data_pipeline_demo/input
